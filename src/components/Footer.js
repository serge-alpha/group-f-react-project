      ...
      <div className="App__footer">
              ...
              <section className="bottom__link">
                  <ul>
                      ...
                      <li><h5><a href="#">FAQs |</a></h5></li>
                      <li><h5><a href="#">TERMS AND CONDITIONS |</a></h5></li>
                      <li><h5><a href="#">POLICIES |</a></h5></li>
                  </ul>
              </section>
              <section className="dev__info">
                  <h6>&copy 2023 CREATED BY //RANDOM TEXT WHICH WILL BE ADDED IN FUTURE AN SO ON</h6>
